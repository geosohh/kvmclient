...
// https://github.com/kentcdodds/Java-Helper/blob/master/src/com/kentcdodds/javahelper/helpers/SwingHelper.java
...
public class ImageHelper {
    ...
    /**
       ...
       */
      public static Image resizeImage(Image image, int width, int height, boolean max) { //NOSONAR
        if (width < 0 && height > 0) {
